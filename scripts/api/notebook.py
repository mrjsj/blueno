...
def get_workspace_notebook(
    ...
    Example:
        ...
        ```python
        from blueno.core import get_workspace_notebook
...
def create_workspace_notebook(
    ...
    Example:
        ```python
        from blueno.core import create_workspace_notebook
...
def update_workspace_notebook_definition(
    ...
    Example:
        ```python
        from blueno.core import update_workspace_notebook_definition
...
def delete_workspace_notebook(workspace_id: str, notebook_id: str) -> requests.Response:
    ...
    Example:
        ```python
        from blueno.core import delete_workspace_notebook
