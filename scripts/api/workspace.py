...
def get_workspaces() -> list[dict[str, Any]]:
    ...
    Example:
        ```python
        from blueno.core import get_workspaces
...
def get_workspace(workspace_id: str | None = None, workspace_name: str | None = None) -> requests.Response | dict[str, Any]:
    """
    ...
    Example:
        By `workspace_id`:
        ```python
        from blueno.core import get_workspace
...
def create_workspace(workspace_name: str, description: str | None = None) -> requests.Response | dict[str, Any]:
    endpoint = "workspaces"
    data = {
...
def assign_workspace_to_capacity(workspace_id: str, capacity_id: str) -> requests.Response | dict[str, Any]:
    """
...
def update_workspace(workspace_id: str, workspace_name: str | None = None, description: str | None = None) -> requests.Response | dict[str, Any]:
    """
    Updates a workspace.
